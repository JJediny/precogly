...
| `cwe` | taxonomy | CWE weakness enumeration |
...
Review each threat, set severity, and triage any that don't apply by setting a decision status (Accept, Delegate, or Eliminate) with documented rationale.
